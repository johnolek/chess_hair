...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file, 44, 4, 1210);
			add_location(div, file, 43, 0, 1200);
		},

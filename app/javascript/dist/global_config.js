...
// (7:0) {#each pieceSetOptions as option (option)}
function create_each_block_1(key_1, ctx) {
	...
	let mounted;
	let dispose;
	binding_group = init_binding_group(/*$$binding_groups*/ ctx[3][1]);
	...
	const block = {
		...
		c: function create() {
			...
			input = element("input");
			t0 = space();
			t1 = text(/*option*/ ctx[5]);
			t2 = space();
			br = element("br");
			attr_dev(input, "name", "pieceSet");
			attr_dev(input, "type", "radio");
			input.__value = /*option*/ ctx[5];
			set_input_value(input, input.__value);
			add_location(input, file, 8, 4, 233);
			add_location(label, file, 7, 2, 221);
			add_location(br, file, 11, 2, 334);
		...
		m: function mount(target, anchor) {
			...
			input.checked = input.__value === /*$pieceSet*/ ctx[0];
			append_dev(label, t0);
			append_dev(label, t1);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(7:0) {#each pieceSetOptions as option (option)}",
		ctx
	});
...
// (16:0) {#each boardOptions as option(option)}
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			input.__value = /*option*/ ctx[5];
			set_input_value(input, input.__value);
			add_location(input, file, 17, 4, 441);
			add_location(label, file, 16, 2, 429);
			add_location(br, file, 20, 2, 546);
			binding_group.p(input);
			this.first = label;
		},
		m: function mount(target, anchor) {
			insert_dev(target, label, anchor);
			append_dev(label, input);
			input.checked = input.__value === /*$boardStyle*/ ctx[1];
			append_dev(label, t0);
			append_dev(label, t1);
			insert_dev(target, t2, anchor);
			insert_dev(target, br, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(16:0) {#each boardOptions as option(option)}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const get_key = ctx => /*option*/ ctx[5];
	...
	const get_key_1 = ctx => /*option*/ ctx[5];
	...
	const block = {
		c: function create() {
			...
			add_location(h20, file, 5, 0, 139);
			attr_dev(h21, "class", "is-size-2");
			add_location(h21, file, 14, 0, 349);
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*$pieceSet*/ 1) {
				...
				validate_each_keys(ctx, each_value_1, get_each_context_1, get_key);
				each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx, each_value_1, each0_lookup, t2.parentNode, destroy_block, create_each_block_1, t2, get_each_context_1);
			}
...
function instance($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, pieceSet, $$value => $$invalidate(0, $pieceSet = $$value));
	validate_store(boardStyle, 'boardStyle');
	component_subscribe($$self, boardStyle, $$value => $$invalidate(1, $boardStyle = $$value));

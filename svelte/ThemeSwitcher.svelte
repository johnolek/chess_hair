...
<div>
  <button class="icon dark-mode" title="Switch to dark mode" class:hidden={theme === 'dark'} on:click={() => {
      theme = 'dark';
    }}>
  ...
  <button class="icon light-mode" title="Switch to light mode" class:hidden={theme === 'light'} on:click={() => {
      theme = 'light';
    }}>
